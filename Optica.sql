...
CREATE TABLE IF NOT EXISTS `Optica`.`clientes` (
  ...
  `id_cliente_que_recomendo_a_este` INT NULL,
...
-- -----------------------------------------------------
-- Table `Optica`.`Marca_de_gafas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Optica`.`Marca_de_gafas` ;

CREATE TABLE IF NOT EXISTS `Optica`.`Marca_de_gafas` (
  `id_Marca_de_gafas` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(60) NOT NULL,
  `id_proveedor` INT NOT NULL,
  PRIMARY KEY (`id_Marca_de_gafas`),
  CONSTRAINT `fk_Marca_de_gafas_proveedor1`
...
CREATE INDEX `fk_Marca_de_gafas_proveedor1_idx` ON `Optica`.`Marca_de_gafas` (`id_proveedor` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `Optica`.`gafas` (
  ...
  CONSTRAINT `fk_gafas_proveedor`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_gafas_Marca_de_gafas1`
    FOREIGN KEY (`id_marca`)
    REFERENCES `Optica`.`Marca_de_gafas` (`id_Marca_de_gafas`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `fk_gafas_Marca_de_gafas1_idx` ON `Optica`.`gafas` (`id_marca` ASC) VISIBLE;
